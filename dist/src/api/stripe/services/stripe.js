...
const stripe = new stripe_1.default(process.env.STRIPE_SECRET_KEY || 'sk_test_simulacion', {
...
exports.default = () => ({
    ...
    validateWebhook(payload, signature) {
        try {
            const event = stripe.webhooks.constructEvent(payload, signature, process.env.STRIPE_WEBHOOK_SECRET || 'whsec_test');
